function generate_train_mix( noise_ch, dB, repeat_time, train_list, TMP_STORE)
    ...
    snr_num = length(dB);
        ...
        for i=1:snr_num
            ...
            for j=1:noise_num
                noise_name = tmp_str{j};
                fprintf('noise type: %12s noise # %d\n', noise_name ,j)
            ...
            save([save_path, 'train_', noise_name, '_mix_bef2.mat'], 'small_mix_cell', 'small_speech_cell', 'small_noise_cell', 'c_mat', '-v7.3');
            warning('on','all');
